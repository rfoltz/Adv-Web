            ...
            <div class="main wrapper clearfix">
                ...
                <article>
                    ...
                    <section class="slider">
                    	<div id="actionButton"><a href="projects.php">View more of my Projects</a></div>
                        <div class="flexslider">
                          <ul class="slides">
                            <li>
                            <a href="projects.php#website"><img src="imgs/mobile.png" alt="iPhone Image"/></a>
                            </li>
                            <li>
                             <a href="projects.php#game"><img src="imgs/game.png" alt="Game Image"/></a>
                            </li>
                            <li>
                             <a href="projects.php#youtube"><img src="imgs/youtube.png" alt="Youtube Image"/></a>
                            </li>
                          </ul>
                        </div>
                      </section>
