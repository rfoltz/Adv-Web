...
File Description: This is the projects page of my portfolio site.
-->
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- This below is the css for the github ribbon on the top right-->
    ...
    <div id="github-ribbon" class="github-fork-ribbon-wrapper right">
        <div class="github-fork-ribbon">
            <a href="https://github.com/rfoltz" title="Fine me on GitHub">Find me on GitHub</a>
        </div>
    </div>
			...
			C289.202,48.178,289.965,50.917,292.368,50.373L292.368,50.373z"/>
            	...
            	<nav>
                    <ul>
                        ...
                        <li class="hide"><a href="login.php">Business Contacts</a></li>
    ...
    -->
        <div class="main-container">
            <div class="wide main wrapper clearfix">
				...
				<a class="gone b-login" href="login.php">Log Into Business Contacts</a>
                <article>
                    <header>
                        <h1>Projects</h1>
                    </header>
                    
                     <section id="website" class="clearfix">
                        <h2>My Website</h2>
